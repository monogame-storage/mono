-- THE DARK ROOM: LETHE
-- Agent 35 | Wave 4 | Narrative Expansion
...
local function snd_flash()
  sfx_note(0, "B6", 0.04) sfx_note(1, "G5", 0.06) sfx_note(2, "D4", 0.08)
end
...
-- Garden peace flag (changes ambient after full tape)
local garden_peace = false

-- Tape recorder part tracker
local tape_part = 0
...
local function trigger_flash(txt)
  flash_active = true
  flash_timer = 5
  flash_text = txt or ""
  snd_flash()
...
local ITEMS = {
  matches   = {name="Matches",     desc="Three matches. Won't last long.",  icon="M",
    thought="The sulfur smell hits you. Familiar. You have lit matches in the dark before. Many times."},
  lens      = {name="Glass Lens",  desc="Cracked magnifying lens.",         icon="O",
    thought="The crack runs through the center like a scar. Through it, the world splits in two."},
  lantern   = {name="Lantern",     desc="Makeshift light. Barely enough.",  icon="*",
    thought="A pitiful flame behind dirty glass. But after so long in darkness, it feels like the sun."},
  wire      = {name="Wire",        desc="Thin copper wire.",                icon="W",
    thought="Copper, green with age. How long has this been here? How long have you?"},
  metal_rod = {name="Metal Rod",   desc="Short iron rod.",                  icon="I",
    thought="Heavy in your hand. The weight is grounding. Something real in this unreal place."},
  lockpick  = {name="Lockpick",    desc="Bent wire pick.",                  icon="P",
    thought="Your fingers shaped this without thinking. Muscle memory from a life you cannot recall."},
  tape      = {name="Tape",        desc="Roll of electrical tape.",         icon="T",
    thought="Black tape. You peel a strip and the adhesive smell makes your stomach turn. Why?"},
  fuse_dead = {name="Dead Fuse",   desc="Blown 30-amp fuse.",              icon="F",
    thought="The glass is blackened from the inside. Something burned hot and fast."},
  fuse_good = {name="Fixed Fuse",  desc="Taped fuse. Might work.",         icon="f",
    thought="Crude but functional. Like you. Broken but still going."},
  keycard   = {name="Keycard",     desc="Dr. Wren - Level 4 Access.",      icon="K",
    thought="The photo on the card. That face. You know it. You KNOW it. But from where?"},
  note_l    = {name="Note(left)",  desc="Torn paper: '74..'",              icon="1",
    thought="The handwriting is yours. You are certain of this even though you cannot remember writing it."},
  note_r    = {name="Note(right)", desc="Torn paper: '..39'",              icon="2",
    thought="The other half. You tore this yourself. A breadcrumb for a mind about to be emptied."},
  full_note = {name="Full Note",   desc="Code: 7439",                      icon="N",
    thought="7439. The number feels like a key to more than just a door."},
  crowbar   = {name="Crowbar",     desc="Heavy. Pries things open.",       icon="C",
    thought="The heft of it is reassuring. For the first time, you feel capable of something."},
  evidence  = {name="Evidence",    desc="Subject 17 file. Proof.",         icon="E",
    thought="Your face stares up from the photographs. Empty-eyed. Slack-jawed. That is what they reduce you to."},
  journal1  = {name="Journal p.1", desc="Day 1: They moved me here.",      icon="J",
    thought="Your handwriting. Your words. A version of you wrote this. A version they erased."},
  journal2  = {name="Journal p.2", desc="Day 15: They erase us.",          icon="J",
    thought="The ink is smudged in places. Were those tears? Sweat? How afraid were you?"},
  journal3  = {name="Journal p.3", desc="Day 31: I am Subject 17.",        icon="J",
    thought="The final entry. The last thing the previous you ever wrote. Before they took it all away. Again."},
  master_key= {name="Master Key",  desc="Heavy brass key. Final door.",    icon="Q",
    thought="Brass, cold, ancient. This key has opened more than doors. It has opened graves."},
  mirror_shard={name="Mirror Shard",desc="A piece of broken mirror.",      icon="V",
    thought="You turn it over. Your reflection stares back. But the face -- the face is not quite right. Older. Harder. Wearing a white coat."},
}
...
local function reset_flags()
  flags = {
    ...
    mirror_examined = false,
    room_narrated = {},
    cell_wall_seen = false,
    corr_gurney_seen = false,
    lab_chair_seen = false,
    ofc_painting_seen = false,
    garden_bench_seen = false,
    garden_plants_seen = false,
  }
end
...
local room_narratives = {
  [1] = "Pitch black. Cold concrete. Your head throbs with hollow pain. The air tastes of rust and something chemical -- sweet, like rotting flowers. You feel the edges of a narrow cot. Your fingers find grooves in the wall beside it. Tally marks. Hundreds of them. Your fingertips fit perfectly into the grooves, as if they carved every one. You do not remember making them. You do not remember anything.",
  [2] = "A corridor stretches into red-tinged gloom. Emergency lights cast sick pools of color every few meters. Green institutional tile, cracked and water-stained. Boot scuffs streak the floor in long desperate arcs -- someone was dragged here. A sign reads: SUBLEVEL 4 - RESTRICTED. You have walked this corridor before. Your legs know the way even if your mind does not. The walls hum with something beneath the silence.",
  [3] = "Shelves loom like the ribs of some dead animal. The chemical smell is stronger here -- it coats the back of your throat and makes your eyes water. Syringes. Restraints. Unlabeled vials of pale liquid. Glass crunches under your feet. A label catches your eye: LETHE COMPOUND B.7. Whatever they use on you, this is where they keep it. Against the far wall, something glints -- a shard of mirror, reflecting a face you almost recognize.",
  [4] = "The lab hums with dead silence -- the kind that presses against your eardrums. In the center stands an examination chair with leather restraints worn smooth from use. Stains darken the leather where wrists would rest. Electrodes dangle from a headpiece above it, trailing wires to a bank of dead monitors. Your body goes cold. Not from fear -- from recognition. You have sat in this chair. Your bones remember even when your mind cannot.",
  [5] = "An office. Papers everywhere -- on the desk, the floor, pinned to the walls in overlapping layers of madness. A portrait of a man in a white coat stares down at you with painted eyes. The nameplate reads DR. H. WREN, DIRECTOR. Something about that face. You almost remember. Almost. A coffee cup sits on the desk. You touch it. Stone cold. It has been cold for months.",
  [6] = "A blast door. Military-grade steel, scarred with deep claw marks -- four parallel gouges, over and over, as if something tried to tear through from this side. An old evacuation sign hangs crooked: SURFACE ACCESS - AUTHORIZED PERSONNEL ONLY. Beyond this door: the surface. Freedom. A keypad blinks beside it, patient and red, waiting for a code. A dark trail leads from the door to the west wall. Old. Brown. Blood.",
  [7] = "Moonlight. After so long in fluorescent hell, actual moonlight. It falls through a grated skylight and pools on cracked flagstones like liquid silver. A small enclosed garden, dead and overgrown but achingly real. The air here is different -- it moves. Wind. You had forgotten wind existed. In the center, a stone bench, worn smooth by someone who sat here often. On the bench, a tape recorder. Someone left this here. Someone who knew you would come. Who knew you would need to hear what it contains.",
}
...
local function draw_room_base(s)
  ...
  -- Garden special: moonlight particles
  if cur_room == 7 then
    local f = frame()
    for i = 1, 8 do
      local px = (f * 3 + i * 29) % (W - 40) + 20
      local py = (f * 2 + i * 41) % 40 + 40
      local bright = (f + i * 7) % 20 < 12 and WHITE or LIGHT
      pix(s, px, py, bright)
    end
  end
end
...
local function draw_mirror_shard(s, x, y)
  local c = has_light and WHITE or LIGHT
  -- Triangular shard shape
  line(s, x, y + 10, x + 5, y, c)
  line(s, x + 5, y, x + 10, y + 8, c)
  line(s, x + 10, y + 8, x, y + 10, c)
  -- Reflection glint
  if has_light and frame() % 30 < 15 then
    pix(s, x + 4, y + 4, WHITE)
    pix(s, x + 5, y + 5, WHITE)
  end
end
...
local function build_hotspots()
    ...
    {x=60, y=42, w=28, h=36, name="cell_door",
      ...
      interact=function()
        ...
        elseif has_light then
          ...
          show_typewriter("A heavy door. Your hands find the seam in the dark, the cold metal frame. The lock mechanism is thick with rust. You cannot see it, but your fingers trace its shape with unsettling familiarity. You need light.", 1)
          snd_locked()
        end
      end
    }
    ...
    {x=40, y=44, w=50, h=28, name="cell_wall",
      draw=function(s, hs)
        ...
        if has_light then
          ...
          -- Bloodstain
          pix(s, hs.x + 38, hs.y + 4, DARK)
          pix(s, hs.x + 39, hs.y + 5, DARK)
          pix(s, hs.x + 37, hs.y + 6, DARK)
        end
      end,
      interact=function()
        if has_light then
          if not flags.cell_wall_seen then
            flags.cell_wall_seen = true
            show_typewriter("The tally marks go on and on. Hundreds. You trace them with your finger and your hand knows the motion. Some are neat, precise. Others are jagged, desperate -- carved with fingernails, not tools. Dried blood darkens the deepest ones.\nAt the bottom, scratched into concrete: 'THEY ERASE YOU. DO NOT FORGET. DO NOT TRUST WREN.'\nBelow, smaller, shakier: 'Keycard taped behind pipe. Corridor.'\nAnd below that, nearly illegible: 'My name was' -- but the rest is gouged out. Someone tried to remember. Someone failed.", 1)
          else
            show_typewriter("You run your fingers along the marks again. Each one a day survived. Each one an act of defiance against forgetting. The blood under your fingernails -- is it old, or fresh? Is it from these marks, or new ones you do not remember making?", 1)
          end
        else
          show_typewriter("Rough scratches under your fingertips. Deep grooves in concrete. Your fingers find the pattern without looking -- they have traced these marks before. The wall is a braille diary you cannot read in the dark.", 1)
        end
      end
    }
  }
    ...
    {x=45, y=50, w=50, h=20, name="cell_cot",
      ...
      interact=function()
        if not has_item("journal1") and has_light then
          ...
          trigger_flash("...a room with sunlight...")
          show_typewriter("JOURNAL - DAY 1\nThey moved me to sublevel 4 after I found the files. Dr. Wren says it is for my own safety. The door locked behind me. I heard him whisper to someone in the hall -- something about 'the schedule.'\nThe cell smells of bleach and old fear. The cot is stained. I keep thinking about my daughter. Does she know I am here? Does she think I am dead?\nI do not believe a word Wren says. There is something wrong with his eyes. They do not blink enough. I will hide these pages where they cannot find them. If they take my memories again, perhaps some part of me will know to look.", 1)
        elseif not has_light then
          show_typewriter("A narrow cot. The mattress is thin and damp. Your body settles into it with the ease of long habit. Something crinkles beneath the pillow. Paper? You cannot see.", 1)
        else
          show_typewriter("Your cot. Still warm from your body. How long were you unconscious? The impression in the mattress is deep -- shaped exactly to you, worn down over months. Or years.", 1)
        end
      end
    }
  }
  ...
  hotspots[14] = {
    {x=50, y=52, w=36, h=20, name="cell_floor",
      ...
      interact=function()
        if not has_item("matches") then
          add_item("matches")
          show_typewriter("Matches! Three left in the box. The striking surface is nearly worn through. You clutch them like a lifeline. In the dark, fire is everything.", 1)
        elseif not has_item("lens") and has_light then
          add_item("lens")
          show_typewriter("A cracked magnifying lens, half-buried in dust. Laboratory grade. Someone dropped it -- or threw it. The crack splits your reflection into two halves that do not quite line up.", 1)
        elseif not has_light then
          show_typewriter("Something small on the cold floor. Your fingers close around a box. Cardboard. Light. The rattle of wooden sticks inside. Hope.", 1)
        else
    ...
    {x=55, y=42, w=28, h=36, name="corr_lab_door",
      ...
      interact=function()
        if has_item("keycard") or held_item == "keycard" then
          ...
          snd_locked()
          show_typewriter("Card reader glows red. A single LED, like a watching eye. You need a keycard. The door is steel, hospital-grade. Through the gap at the bottom, you smell ozone and old sweat.", 1)
        end
      end
    }
  }
    ...
    {x=30, y=44, w=34, h=24, name="corr_notices",
      ...
      interact=function()
        if has_light then
          ...
          show_typewriter("MEMORANDUM - CONFIDENTIAL\nFrom: Dr. H. Wren, Director\nTo: All Level 4 Staff\nRe: Project LETHE Protocol\n'REMINDER: All test subjects must be fully sedated BEFORE memory wipe procedure. Unsedated wipes cause permanent neural damage, identity fragmentation, and in three cases, death. This is not a suggestion.'\nBelow, someone has scrawled in pencil: 'Wren doesn't sedate 17 anymore. Says it builds tolerance. 17 screams for twenty minutes each time. I can't do this.'\nThe pencil note is unsigned.", 1)
        else
  ...
  -- West: pipes (keycard) + storage door + gurney
  hotspots[24] = {
    {x=28, y=42, w=30, h=14, name="corr_pipes",
      ...
      interact=function()
        if not flags.keycard_found and has_light then
          ...
          add_item("keycard")
          show_typewriter("Behind the third pipe, exactly where the wall said it would be. A keycard, wrapped in electrical tape to keep it dry. DR. WREN, H. - LEVEL 4 ACCESS. The photo shows a man with kind eyes. But something about the lamination -- it is peeling. As if the card is older than the photo.", 1)
        elseif not has_light then
          show_typewriter("Pipes overhead. Dripping. The condensation runs down your fingers. Somewhere in the tangle of metal, something is taped to a joint. You can feel the edges but cannot see it.", 1)
        else
  ...
  -- North: shelves with wire and metal rod + mirror shard
  hotspots[31] = {
    {x=35, y=42, w=30, h=36, name="stor_shelf_l",
      ...
      interact=function()
        if not has_item("wire") and has_light then
          add_item("wire")
          show_typewriter("Thin copper wire, coiled on a shelf between empty syringes and a cracked clipboard. The clipboard reads: 'SUBJECT 17 - SESSION LOG.' The entries are numbered up to 31. Each one is stamped COMPLETE.", 1)
        elseif not has_light then
          show_msg("Shelves. Too dark to search.", 40)
        else
          show_msg("Empty shelves. Dust and ghosts.", 40)
        end
      end
    },
    {x=80, y=42, w=30, h=36, name="stor_shelf_r",
      draw=function(s, hs)
        ...
        -- Mirror shard on bottom shelf
        if not has_item("mirror_shard") and has_light then
          draw_mirror_shard(s, hs.x + 4, hs.y + 26)
        end
      end,
      interact=function()
        if not has_item("metal_rod") and has_light then
          add_item("metal_rod")
          show_typewriter("A short iron rod, probably from a broken restraint mechanism. Scratches along its length suggest someone used it to pry at something. The desperation in those marks is palpable.", 1)
        elseif not has_item("mirror_shard") and has_light then
          add_item("mirror_shard")
          story_learn(STORY_MIRROR)
          trigger_flash("...that face is YOUR face...")
          show_typewriter("A shard of mirror, wedged behind rusted equipment. You pick it up and catch your reflection.\nYou freeze.\nThe face looking back is yours -- but wrong. Older. Gaunt. And for one terrible instant, you see it wearing a white coat. A doctor's coat. With a name badge you cannot quite read.\nThe image shifts and it is just you again. Just your face. But your hands will not stop shaking. What did you see? WHAT DID YOU SEE?", 1)
        elseif not has_light then
          show_msg("Metal things. Can't see.", 40)
        else
          show_msg("Rusty equipment. Broken restraints.", 40)
        end
      end
    }
  }
    ...
    {x=40, y=48, w=24, h=18, name="stor_box1",
      ...
      interact=function()
        if not has_item("fuse_dead") and has_light then
          add_item("fuse_dead")
          show_typewriter("A blown fuse. The glass is blackened, the filament melted. Scorch marks around the box suggest it blew violently. Someone overloaded the system on purpose. Sabotage -- or a desperate attempt to shut something down.", 1)
        elseif not has_light then
    ...
    {x=80, y=48, w=24, h=18, name="stor_box2",
      ...
      interact=function()
        if not has_item("tape") and has_light then
          add_item("tape")
          show_typewriter("Electrical tape. Black. The roll is half-used. Someone wrapped something hastily -- loose ends trail from the roll like dark ribbons.", 1)
        elseif not has_light then
    ...
    {x=40, y=44, w=50, h=28, name="stor_chem",
      ...
      interact=function()
        if not has_item("journal2") and has_light then
          ...
          trigger_flash("...hollow eyes in a row of cells...")
          show_typewriter("JOURNAL - DAY 15\nThe other subjects cannot remember their own names. They sit in their cells and stare at walls for hours. Their eyes are hollow, like dolls. Subject 9 stopped eating three days ago. She just rocks back and forth and hums a song that sounds like a lullaby. I held her hand yesterday. She looked at me and said 'Mama?' I am not her mother. I am no one's anything anymore.\nI have been hiding journal pages in walls, in cots, behind chemicals. If they wipe me again, perhaps I will find them.\nThe vials are labeled LETHE COMPOUND B.7. That is what they use to erase us. The liquid inside is clear, almost beautiful. Like water from a poisoned spring.\nI counted the vials. There are enough for a hundred more wipes.", 1)
        elseif has_light then
          show_typewriter("LETHE COMPOUND B.7. You hold a vial up to the light. The liquid catches the glow and refracts it into something almost prismatic. Beautiful. The thing that steals your mind is beautiful. You set it down with shaking hands.", 1)
        else
          show_typewriter("Chemical smell -- sweet and sharp, coating your tongue. Your body recoils. Every cell in you knows this smell and fears it, even if your mind cannot name it.", 1)
        end
      end
    }
  }
    ...
    {x=60, y=46, w=18, h=14, name="lab_fusebox",
      ...
      interact=function()
        ...
        elseif held_item == "fuse_good" or has_item("fuse_good") then
          ...
          show_typewriter("Fuse box. One slot empty, the socket blackened with soot. The wall around it is scorched -- whoever blew this fuse meant it. Scrawled in soot beside it: 'STAY DARK STAY SAFE.'", 1)
        end
      end
    },
    {x=90, y=42, w=28, h=22, name="lab_terminal",
      ...
      interact=function()
        ...
        elseif not flags.terminal_used then
          ...
          trigger_flash("...counting backward from ten...")
          show_typewriter("LETHE TERMINAL v4.7\n> Searching: SUBJECT 17\n> 31 wipe cycles logged\n> Status: ACTIVE\n> Last wipe: 3 days ago\n> Physician: WREN, H. (DECEASED)\n> ERROR: Dr. Wren death cert on file dated 4 months prior to last 12 wipe entries\n> WARNING: Physician ID anomaly detected\n> EXIT OVERRIDE CODE: 7439\nYou stare at the screen. Wren is dead. Has been dead for four months. But someone signed off on twelve wipes since then. Someone wearing his face. Someone using his keycard. The cursor blinks, patient and green, waiting for a command you cannot bring yourself to type.", 1)
        else
    ...
    {x=45, y=46, w=40, h=30, name="lab_chair",
      ...
      interact=function()
        if has_light then
          ...
          if not flags.lab_chair_seen then
            flags.lab_chair_seen = true
            trigger_flash("...count backward from ten...")
            show_typewriter("The restraints are worn smooth from hundreds of sessions. Your wrists fit perfectly into the grooves -- the leather has molded to your exact shape. A placard reads: LETHE ADMINISTRATION STATION 3.\nDark stains mark where wrists strained against the straps. Your wrists. Your blood.\nYou touch the headpiece and the world tilts. A flash -- white light, a voice saying 'count backward from ten' -- and then nothing. A memory of forgetting. The sound of your own screaming, muffled, as if heard from underwater.\nYou pull your hand back, shaking. The chair is still warm. Or is that your imagination? Is anything real here?", 1)
          else
            show_typewriter("You cannot look at the chair without your vision swimming. The headpiece sways gently in a draft you cannot feel. Waiting. Patient. It will always be here, waiting for you to sit down again.", 1)
          end
        else
          show_typewriter("Something bulky with leather straps. Your hands find the armrests and your wrists slide into grooves that fit perfectly. You jerk away. Your body knows this thing. Your body is afraid.", 1)
        end
      end
    }
  }
    ...
    {x=40, y=52, w=60, h=16, name="lab_desk",
      ...
      interact=function()
        ...
        elseif held_item == "lockpick" or held_item == "crowbar" then
          ...
          trigger_flash("...I am Subject 17...")
          show_typewriter("JOURNAL - DAY 31\nI know the truth now. I am not a researcher. I never was. I am Subject 17. They implanted false memories of being staff, of having credentials, of choosing to work here. None of it was real. My daughter -- is she real? Was she ever real? Or did they put her in my head to keep me docile?\nThe real Dr. Wren died four months ago. I found the death certificate in his own files. Someone, or something, is wearing his face. It walks the halls at night. I hear it breathing outside my door. Not human breathing. Something wet and mechanical.\nThe wipes continue on schedule. I must escape with proof before the next cycle. Before I forget again. Before I become no one. Again.\nIf you are reading this and you do not remember writing it: I am sorry. I am you. We have been here before. Find the garden.", 1)
  ...
  hotspots[51] = {
    {x=50, y=44, w=40, h=28, name="ofc_painting",
      ...
      interact=function()
        ...
        elseif has_light then
          if not flags.ofc_painting_seen then
            flags.ofc_painting_seen = true
            show_typewriter("The portrait stares back at you. Dr. Harold Wren, painted in oils. The eyes follow you. The mouth seems to smile differently each time you look.\nYou lean closer. The paint is cracking. And beneath the cracks -- beneath the careful layers of oil and pigment -- another face. Partially visible. Younger. With features that make your stomach drop because they look almost like yours.\nThe signature on the painting reads 'H.W.' But the brushwork is amateur. Wren painted this himself. A portrait of a face he was learning to wear.", 1)
          else
            show_typewriter("Wren's painted eyes. That slight smile. You have seen enough. You know what hides beneath the paint.", 1)
          end
        else
    ...
    {x=55, y=44, w=22, h=30, name="ofc_cabinet",
      ...
      interact=function()
        if not flags.evidence_found and has_light then
          ...
          trigger_flash("...strapped down, screaming...")
          show_typewriter("SUBJECT 17 - CLASSIFIED\nPhotographs. Your face, strapped to the chair. Your eyes open but empty. Your mouth slack. In one photo, your wrists are bleeding where you fought the restraints.\nMedical notes: 31 memory wipes documented. Increasing dosage each time as resistance builds. Side effects: confusion, identity loss, false memory implantation, violent episodes, partial seizures, 'spontaneous vocalization of pre-wipe memories during REM sleep.'\nYou were screaming in your sleep. Screaming things they had tried to erase.\nHandwritten addendum in red ink: 'Subject 17 keeps hiding journal pages. Shows unprecedented wipe resistance. Recommend permanent solution after next audit. -- W.'\nThe 'W' is not Wren's handwriting. It is something else pretending to be.", 1)
    ...
    {x=40, y=52, w=60, h=16, name="ofc_desk",
      draw=function(s, hs)
        ...
        if has_light then
          ...
          -- Cold coffee cup
          rectf(s, hs.x + 50, hs.y + 1, 5, 6, WHITE)
        end
      end,
      interact=function()
        if not has_item("note_r") and has_light then
          add_item("note_r")
          show_typewriter("Memos between 'Wren' and the DIRECTOR. The handwriting changes halfway through the stack -- same signature, different hand. The early letters are measured, clinical. The later ones are hungry.\n'The board is asking questions. Subject 17 must be wiped again before the audit. Maximum dosage. If the subject expires, file it as cardiac failure. We cannot afford scrutiny. Not now. Not when we are so close.'\nClose to what? The sentence trails off.\nDate: three days ago.\nA torn scrap falls out: '..39'", 1)
        elseif has_light then
          show_typewriter("The desk is covered in memos. A cold coffee cup sits at the edge, a ring of mold inside it. Wren's reading glasses lie on a stack of papers, one lens cracked. Did he take them off? Or were they knocked from his face?", 1)
        else
    ...
    {x=50, y=40, w=40, h=38, name="exit_blast_door",
      draw=function(s, hs)
        ...
        if flags.escaped then
          ...
          if has_light then
            for i = 0, 3 do
              line(s, hs.x + 6 + i*3, hs.y + 4, hs.x + 8 + i*3, hs.y + 12, DARK)
            end
          end
        end
      end,
      interact=function()
        if flags.escaped then
          ...
          show_typewriter("The blast door. Military steel, two inches thick. Four sets of claw marks score the surface -- deep, desperate, inhuman. Someone tried to tear through bare-handed. The metal yielded slightly. Whatever made these marks was strong. Or insane. Or both.", 1)
        end
      end
    },
  ...
  hotspots[62] = {
    {x=50, y=50, w=30, h=20, name="exit_debris",
      ...
      interact=function()
        if not has_item("crowbar") and has_light then
          add_item("crowbar")
          show_typewriter("A crowbar, half-buried in rubble from a collapsed section of ceiling. The rubber grip is worn from use. This was not decoration. Someone used this to try to pry open the blast door. The concrete around the frame is chipped and scarred.", 1)
        elseif not has_light then
    ...
    {x=55, y=44, w=28, h=34, name="exit_garden_door",
      draw=function(s, hs)
        ...
        if has_light then
          ...
          for i = 0, 4 do
            pix(s, hs.x - 6 + i * 2, hs.y + hs.h - 2 + (i % 2), DARK)
          end
        end
      end,
      interact=function()
        if has_item("master_key") or held_item == "master_key" then
          ...
          snd_locked()
          show_typewriter("Heavy lock. No ordinary key will open this. A dark trail on the floor leads to the threshold and stops. Someone bled their way to this door and could not get through.", 1)
        end
      end
    }
  }
  ...
  -- North: tape recorder (Wren's final message) - now 3 parts
  hotspots[71] = {
    {x=60, y=48, w=20, h=12, name="garden_recorder",
      draw=function(s, hs)
        draw_tape_recorder(s, hs.x, hs.y)
        if has_light then
          local label = tape_part == 0 and "PLAY?" or (tape_part < 3 and "MORE?" or "END")
          text(s, label, hs.x + 2, hs.y + 14, DARK)
        end
      end,
      interact=function()
        if tape_part == 0 then
          ...
          trigger_flash("...a garden in sunlight...")
          show_typewriter("DR. WREN'S VOICE (RECORDING - PART 1):\n'If you are hearing this, you found my garden. Good. Good. I am the real Harold Wren, and I am already dead by the time you play this. Heart failure, they will say. But it was not my heart that failed.\nI started Project LETHE twenty years ago. Alzheimer's research. We wanted to target specific memories -- trauma, addiction, pain. Help people forget what hurt them. It worked. God help us, it worked too well.\nThe compound does not just erase. It... absorbs. Every memory we wiped went somewhere. Into the compound itself. And after thousands of wipes, thousands of stolen lives and stolen selves...\nSomething woke up inside it.'", 1)
        elseif tape_part == 1 then
          tape_part = 2
          show_typewriter("DR. WREN'S VOICE (RECORDING - PART 2):\n'It learned to wear faces. It learned from the memories it consumed -- how to walk, how to talk, how to smile. It practiced on the subjects first. Taking their mannerisms. Their voices.\nThen it took mine.\nI saw it standing in my office wearing my face. Smiling my smile. It looked at me with my own eyes and said, 'Thank you for the practice, Harold.'\nIt does not kill. That is the worst part. It does not need to kill. It just... wears you. Takes your place. And keeps feeding. Every wipe makes it stronger. Every stolen identity adds to its library of faces.\nThe subjects in the cells -- they are not just wiped. They are hollowed out. Consumed. Their memories feed the thing that wears my face.'", 1)
        elseif tape_part == 2 then
          tape_part = 3
          trigger_flash("...you trusted him once...")
          garden_peace = true
          show_typewriter("DR. WREN'S VOICE (RECORDING - PART 3):\n'Subject 17. I know you. We were colleagues once, before any of this. You were brilliant. You were kind. You brought your daughter to the lab and she called me Uncle Harry.\nI am sorry. I am sorry for all of it. For the chair. For the needles. For every time I said 'count backward from ten' and watched your eyes go empty.\nI built this garden as the one place it cannot reach. The compound does not grow where living things grow. The soil rejects it. I sat here every night and whispered your real name into the dark, hoping some part of you might hear it.\nThe exit code is 7439. Run. Do not look back. And whatever you do -- do not forget. You are more than what they have made you.\n[The tape ends. Wind moves through dead leaves. Somewhere above, a bird calls. The first bird you have heard in years.]'", 1)
        else
          show_typewriter("The tape has played to its end. Wren's voice echoes in your memory -- the only voice in this place that ever spoke the truth. You press the recorder against your chest. A small weight. A small kindness. At least someone tried to save you. At least someone was sorry.", 1)
        end
      end
    }
  }

  -- East: dead garden + bench
  hotspots[72] = {
    {x=40, y=44, w=50, h=28, name="garden_plants",
      draw=function(s, hs)
        ...
        -- Green shoot
        if has_light then
          pix(s, hs.x + 25, hs.y + 22, WHITE)
          pix(s, hs.x + 25, hs.y + 23, LIGHT)
          pix(s, hs.x + 26, hs.y + 21, WHITE)
        end
      end,
      interact=function()
        if not flags.garden_plants_seen then
          flags.garden_plants_seen = true
          show_typewriter("Dead flowers. Dead vines. The stalks are brittle and snap at a touch, releasing the ghost of a scent -- lavender? Roses? You do not know the names. But your hands know how to tend them. Your fingers curl around the stems with practiced gentleness.\nA single green shoot pushes up through the brown. New growth. Defiant and impossibly alive. You touch it and the leaf unfurls slightly, reaching toward the moonlight.\nWren tended this garden. And before him? The soil is dark and rich. Someone loved this place. Someone who knew that even in a facility built for forgetting, something must be allowed to grow.", 1)
        else
          show_typewriter("The green shoot has grown a fraction since you last looked. Or perhaps you imagined it. In this place, hope and hallucination feel the same.", 1)
        end
      end
    }
  }
  ...
  hotspots[74] = {
    {x=45, y=42, w=40, h=30, name="garden_window",
      draw=function(s, hs)
        ...
        pix(s, hs.x + 18, hs.y + 14, LIGHT)
        -- Bench below window
        local bx, by = hs.x + 8, hs.y + hs.h + 2
        rectf(s, bx, by, 24, 4, has_light and LIGHT or DARK)
        rectf(s, bx + 2, by + 4, 3, 4, has_light and LIGHT or DARK)
        rectf(s, bx + 19, by + 4, 3, 4, has_light and LIGHT or DARK)
      end,
      interact=function()
        if not flags.garden_bench_seen then
          flags.garden_bench_seen = true
          trigger_flash("...stars, and a child laughing...")
          show_typewriter("Through the grate, the night sky. Stars. You had forgotten that stars existed. Tears sting your eyes. Not from sadness. From recognition. The world is still there. It waited for you.\nThe stone bench is worn smooth. Carved into its surface, barely legible: 'H.W. & S.17 - REMEMBER THE STARS.'\nWren and Subject 17. He sat here with you. In some previous cycle, some previous life, you sat side by side on this bench and looked at the same stars. And for that moment, you were not doctor and subject. You were two people trying to remember what it meant to be human.", 1)
        else
          show_typewriter("The stars. The bench. The silence. In this garden, for the first time since waking, you feel something other than fear. You feel grief. And grief means you remember enough to mourn.", 1)
        end
      end
    }
  }
...
local function update_ambient()
  if garden_peace and cur_room == 7 then
    -- Peaceful ambient in garden after full tape
    amb_creak_timer = amb_creak_timer - 1
    if amb_creak_timer <= 0 then
      amb_creak_timer = 120 + math.random(60)
      sfx_note(3, "A5", 0.04) -- gentle wind
    end
    return
  end
...
local function get_ending()
  ...
  -- 4th ending: all 8 bits + mirror shard (the 9th)
  if bits >= 8 and story_known(STORY_MIRROR) then return 4 end
  ...
  if inv_open then
    ...
    if btnp("a") and #inv > 0 and inv[inv_sel] then
      ...
      elseif combine_mode then
        ...
        -- Show inner thought for item
        local item = inv[inv_sel]
        if ITEMS[item] and ITEMS[item].thought then
          show_typewriter(ITEMS[item].thought, 1)
...
local function draw_game(s)
  ...
  -- 9th bit indicator (mirror)
  if story_known(STORY_MIRROR) then
    pix(s, 76 + 18, H - 2, LIGHT)
  end
  ...
  -- Memory flash overlay (5 frames, inverted)
  if flash_active then
    flash_timer = flash_timer - 1
    -- Invert all pixels for flash effect
    for fy = 0, H - 1 do
      for fx = 0, W - 1 do
        local p = pix(s, fx, fy)
        pix(s, fx, fy, 3 - p)
    ...
    -- Flash text centered
    if #flash_text > 0 then
      local tw = #flash_text * 4
      rectf(s, 80 - tw // 2 - 2, 56, tw + 4, 9, WHITE)
      text(s, flash_text, 80 - tw // 2, 58, BLACK)
    end
...
local ending_texts = {
  ...
  -- Ending 4: The Cycle
  "The blast door opens. But you do not move.\nYou saw your face in the mirror shard. Older. Gaunt. Wearing a white coat. And now, standing at the threshold of freedom, the final piece falls into place like a bone snapping.\nThe Entity is not some alien presence. It is not a demon conjured from stolen memories. It is you. A previous iteration of Subject 17, wiped so many times that your consciousness detached, dissolved into the LETHE compound, and reformed as something else. Something hungry. Something that wears faces because it has forgotten its own.\nYou are the prisoner. You are also the warden. Every cycle, one version of you escapes while another stays behind to feed the machine. The thing wearing Wren's face has your eyes. Your hands. Your daughter's name on its lips.\nYou step through the door. The night air is cold. Behind you, in the depths of Sublevel 4, something stirs. Sits up in a narrow cot. Touches the tally marks on the wall. Finds matches in the dark.\nThe cycle begins again.\nTHE CYCLE\n(You found all nine fragments. You learned the terrible truth: the monster was always you.)",
}
...
local function draw_ending(s)
  ...
  if ending == 4 then
    -- Pulsing dark for cycle ending
    local pulse = math.sin(ending_timer * 0.05) * 0.5 + 0.5
    local pw = math.floor(pulse * 60)
    dither_rectf(s, math.floor(80 - pw / 2), 0, pw, H, BLACK, DARK, 1)
  ...
  for i = 1 + scroll, math.min(#lines, scroll + max_vis) do
    ...
    local tc = LIGHT
    if ln == "IGNORANCE IS MERCY" or ln == "HALF-REMEMBERED" or ln == "FULL REVELATION" or ln == "THE CYCLE" then
      tc = WHITE
